...
const GameCard = ({ title, description, path, isComingSoon = false, backgroundColor, icon }: GameCardProps) => {
  return (
    <div className={`rounded-lg p-6 ${backgroundColor} flex flex-col items-center`}>
      <div className="w-24 h-24 mb-4 bg-white/10 rounded-lg flex items-center justify-center text-4xl">
        {icon}
      </div>
